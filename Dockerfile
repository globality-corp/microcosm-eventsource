...
ENV NAME microcosm_eventsource
...
ARG BUILD_NUM
ARG SHA1
ENV MICROCOSM_EVENTSOURCE__BUILD_INFO_CONVENTION__BUILD_NUM ${BUILD_NUM}
ENV MICROCOSM_EVENTSOURCE__BUILD_INFO_CONVENTION__SHA1 ${SHA1}
COPY $NAME /src/$NAME/
