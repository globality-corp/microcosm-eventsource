...
class RollUpStoreAsync:
    ...
    async def _retrieve_container(self, identifier):
        """
    ...
    async def _search_container(self, **kwargs):
        """
    ...
    async def _container_subquery(self, query):
        """
    ...
    async def _rollup_query(self, container, aggregate, **kwargs):
        """
    ...
    async def _query(self, container, aggregate):
        """
